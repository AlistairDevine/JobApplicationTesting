    ...
    public static class GenericTextFileProcessor
    {
        public static List<T> LoadFromTextFile<T>(string filePath) where T : class, new()
        {
            ...
            foreach (var row in lines)
            {
                ...
                //the matching columns, we can do the "SetValue" method to
        ...
        public static void SaveToTextFile<T>(List<T> data, string filePath) where T : class
        {
            ...
            {
                throw new ArgumentNullException("data", "You must populate the data parameter with at least one entry");
            }
